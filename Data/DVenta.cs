    ...
    public class DVenta
    {
        public static List<Venta> GetAll()
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("GetAllVentas", connection);
                connection.Open();
                SqlDataReader reader = command.ExecuteReader();
                while (reader.Read())
                {
                    Cliente cliente = DCliente.GetById(Convert.ToInt32(reader["idCliente"]));
                    TipoComprobante tipoComprobante = DTipoComprobante.GetById(Convert.ToInt32(reader["idTipo"]));
                    ...
                    CentroCosto centroCosto = DCentroCosto.GetById(Convert.ToInt32(reader["idCentro"]));
                    ...
                    var venta = new Venta(
                        ...
                        Convert.ToDouble(reader["percIVA"]),
        ...
        public static void InsertVenta(int codCliente, int codTipoComprobante, int codMoneda, int codCuenta, DateTime fecha, int imputacion, decimal tipoCambio, int punto, string numero, double netoGravado, double netoNoGravado, double exento, double iva, double percIVA, double percIIBB, double percMunicipalidad, int codCentroCosto
)
        {
            try
            {
                ...
                command.Parameters.AddWithValue("@codCuenta", codCuenta);
